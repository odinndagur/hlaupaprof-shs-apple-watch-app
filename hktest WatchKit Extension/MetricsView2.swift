...
//
//  Created by Óðinn Dagur Bjarnason on 3.1.2022.
//
...
//    }
    ...
    var body: some View {
        TimelineView(Metrics2TimelineSchedule(from: workoutManager.builder?.startDate ?? Date())) { context in
...
struct MetricsView2_Previews: PreviewProvider {
    static var previews: some View {
        MetricsView2().environmentObject(WorkoutManager())
    }
}

private struct Metrics2TimelineSchedule: TimelineSchedule {
    var startDate: Date
